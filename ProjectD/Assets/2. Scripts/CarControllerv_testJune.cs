...
public class AxleInfo
{
    ...
    public void FixedUpdate()
    {
        ...
        accellInput = Input.GetAxis("Vertical");
        //convert inputs to torques
        float steer = steerSlider.value * maxSteeringAngle / (1080.0f / 2);
    ...
    public void Update()
    {
        ...
        gearratiostext.text = "WHEEL POSITION " + steerInput.ToString("F3");
        torqueCurvetext.text = "Torque " + rpmCurve.Evaluate(currentRPM / maxRPM);
